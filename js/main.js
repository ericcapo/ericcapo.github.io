    ...
    return `
        <div class="micromates-wrapper">
            ...
            <div class="game-header">
                ...
                <p style="text-align: justify;"><strong>What is MicroMates<sup>™</sup>?</strong> You collect little creatures called mates, each living in an unique ecosystem (a family) and powered by one of five sources of energy. </p><br>
                <p style="text-align: justify;"><strong>MicroMates<sup>™</sup> Families</strong> (2–5 players): Shuffle and deal 7 cards each. Youngest goes first. On your turn, ask any player for a mate from a specific family using one of the five energy types. If they have it, take it and continue your turn; if not, draw one card from the pile. Whenever you collect all five energy sources of the same family, show it and place it face up. First to get <strong>3 families</strong> wins!</p><br>
                <p style="text-align: justify;"><strong>Oceanic Duel</strong> (1 player): <a href="https://www.capolab.net/oceanicduel.html" target="_blank" style="color: white !important;">Click here to play</a></p>
                <br>Energy types:</p> 
...
<p>The Capo lab study how <b>aquatic microbial communities</b> change across space and time, and how they functionally respond to climate change, eutrophication, deoxygenation, and mercury pollution. We apply <b>molecular ecology</b> tools - metabarcoding, (ancient) metagenomics, MAGs analysis, and metatranscriptomics - to the genetic information present in water columns and sediment archives, capturing a high-resolution record of microbial life. Reconstructing <b>long-term microbial changes</b> helps us link past ecosystem states to present dynamics, improving predictions of future aquatic ecosystem trajectories under ongoing environmental change.</p>
