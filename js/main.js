    ...
    return `
        <div class="micromates-wrapper">
            ...
            <div class="game-header">
                ...
                <p style="text-align: justify;"><strong>MicroMates<sup>™ Families</strong> (2–5 players): Shuffle and deal 7 cards each. Youngest goes first. On your turn, ask any player for a mate from a specific realm using one of the five energy types. If they have it, take it and continue your turn; if not, draw one card from the pile. Whenever you collect all five energy sources of the same realm, show it and place it face up. First to get <strong>2 realms</strong> wins!</p><br>
